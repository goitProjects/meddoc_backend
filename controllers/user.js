...
module.exports.updateInfo = async (req, res) => {
  ...
  new_userInfo = await User.findByIdAndUpdate(req.user, {
    "user.userInfo": { ...new_userInfo },
  });
  ...
  try {
    ...
    User.findOne({ phone }).then((user) => {
      ...
      newUser.save().then((user) => {
        ...
        User.findByIdAndUpdate(_id,{ accessToken, refreshToken }, { new: true }).then(() => {
            const userData = {
                name,
                phone,
                role,
...
module.exports.userLogin = async (req, res, next) => {
  try {
    ...
    await User.findByIdAndUpdate(_id,{ accessToken, refreshToken }, { new: true })
    return res.json({
      id: String(_id),
      name,
      phone,
